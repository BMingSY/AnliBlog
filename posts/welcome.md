...
| Layer | Technology |
|-------|------------|
| **Framework** | [Next.js 14](https://nextjs.org/) (React-based, SSR/SSG support) |
| **UI Library** | [React 18](https://react.dev/) |
| **Styling** | CSS (custom, clean and minimal) |
| **Content** | Markdown (`.md` files parsed by [gray-matter](https://github.com/jonschlinkert/gray-matter)) |
...
```javascript
function greet(name) {
  return `Hello, ${name}! Welcome to Anli's Blog.`;
}
